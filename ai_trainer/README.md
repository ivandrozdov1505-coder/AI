...
### Вариант 1: Автоматическая установка и запуск (Windows)

Просто запустите файл `install_and_run.bat` - он автоматически:
...
```bash
# Дважды кликните на install_and_run.bat или запустите из командной строки
install_and_run.bat
```
